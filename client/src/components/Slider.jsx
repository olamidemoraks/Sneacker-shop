      ...
      >
        ...
        <div className="flex flex-col justify-center items-center relative w-full">
          ...
          >
            ...
            <span className="text_background lg:block hidden">
              {name.split(" ")[2]}
            </span>
          </motion.p>
        </div>
        <motion.div
          ...
          className="flex justify-between mx-auto max-w-[100%] md:w-[50%] w-[70%] absolute md:bottom-[40px] bottom-[60px] items-end"
        >
